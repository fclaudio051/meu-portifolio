export const projects = [
  ...
  },
  {
    ...
    description: 'Calculadora simples para calcular o Índice de Massa Corporal (IMC) com base na altura e peso informados pelo usuário.',
    tech: ['React', 'Tailwind', 'JavaScript', 'Vercel'],
    links: {
      github: 'https://github.com/fclaudio051/React-calc-imc.git',
      vercel: 'https://fclaudio051.github.io/React-calc-imc/'
    }
  },
  // outros projetos...
];
